...
input_field_to.height = 44
input_field_from.height = 44
plan_button.y = 680
markerA.opacity = 1
markerB.opacity = 0
markerB.y = 50
...
# input_field_from.onClick ->
# 	input_field_from.animate input_choose()
# 	input_field_to.animate input_empty()
# input_field_from.onClick ->
# 	input_field_from.animate input_empty()

input_field_to.onClick ->
	input_field_to.animate input_choose()
	input_field_from.animate input_empty()
	Utils.delay 0.08, ->
		input_field_2_suggestion.animate
			opacity: 1
			options: 
				time: 0.16
				curve: defaultEaseOut

input_field_2_suggestion.onClick ->
	input_field_to.animate input_empty()
	input_field_2_suggestion.opacity = 1
	input_field_2_suggestion.animate
		y: 12
		options:
			time: 0.16
			curve: defaultEaseOut
	input_field_2_placeholder.animate
		opacity: 0
		options: 
			time: 0.08
			curve: defaultEaseIn
...
# safari_1.onClick ->
# 	input_field_to.animate input_empty()
# 	input_field_2_suggestion.width = 1
# 	input_field_2_suggestion.animate
# 		opacity: 0
# 		options: 
# 			time: 0.08
